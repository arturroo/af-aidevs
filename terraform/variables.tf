...
variable "datasets" {
    ...
    default = {
        ...
        "s03e05" = {
            description = "Dataset for S03E05 savethem autonomous routing tasks"
        }
        "s04e01" = {
...
variable "internal_tables" {
    ...
    default = {
        ...
        "s03e05_audit" = {
            table_id    = "audit"
            description = "Audit logs for S03E05 savethem autonomous routing service"
            dataset_id  = "s03e05"
            schema      = "bq-schemas/s01e04.audit.json" # Reusing schema
        }
        "s04e01_audit" = {
...
variable "cr_names" {
    ...
    default = {
        ...
        "cr-s02e05-drone" = {
            source_dir    = "../lessons/s02e05-projektowanie-agentow/task/cr-s02e05-drone"
            cpu           = "1"
            memory        = "1Gi"
            public        = false
            cpu_idle      = true
            ...
            env           = {
                ...
                BQ_DATASET         = "s02e05"
                BQ_TABLE           = "audit"
                BQ_AUDIT_TABLE     = "af-aidevs.s02e05.audit"
                LANGSMITH_TRACING  = "true"
                LANGSMITH_ENDPOINT = "https://eu.api.smith.langchain.com"
            }
            roles         = ["roles/bigquery.jobUser", 
                             ...
                             "roles/aiplatform.user"]
            dataset_roles = {
                "s02e05" = ["roles/bigquery.dataEditor"]
            }
            cr_roles = {
                "cr-mcp-workspace"   = ["roles/run.invoker"]
                "cr-mcp-web-gateway" = ["roles/run.invoker"]
        ...
        "cr-s03e02-firmware" = {
            source_dir    = "../lessons/s03e02-ograniczenia-modeli-na-etapie-zalozen-projektu/task/cr-s03e02-firmware"
            cpu           = "1"
            memory        = "1Gi"
            public        = false
            cpu_idle      = true
            ...
            env           = {
                ...
                BQ_DATASET         = "s03e02"
                BQ_TABLE           = "audit"
                BQ_AUDIT_TABLE     = "af-aidevs.s03e02.audit"
                LANGSMITH_TRACING  = "true"
                LANGSMITH_ENDPOINT = "https://eu.api.smith.langchain.com"
            }
            roles         = ["roles/bigquery.jobUser", 
                             ...
                             "roles/aiplatform.user"]
            dataset_roles = {
                "s03e02" = ["roles/bigquery.dataEditor"]
            }
            cr_roles = {
                "cr-mcp-workspace"   = ["roles/run.invoker"]
                "cr-mcp-web-gateway" = ["roles/run.invoker"]
        ...
        "cr-s03e05-savethem" = {
            source_dir    = "../lessons/s03e05-niedeterministyczna-natura-modeli-jako-przewaga/task/cr-s03e05-savethem"
            cpu           = "1"
            memory        = "1Gi"
            public        = false
            cpu_idle      = true
            ...
            env           = {
                ...
                BQ_DATASET          = "s03e05"
                BQ_TABLE            = "audit"
                BQ_AUDIT_TABLE      = "af-aidevs.s03e05.audit"
                GEMINI_MODEL        = "gemini-3.8-flash"
                THINKING_LEVEL      = "low"
                LANGSMITH_TRACING   = "true"
                LANGSMITH_ENDPOINT  = "https://eu.api.smith.langchain.com"
            ...
            roles         = ["roles/bigquery.jobUser", 
                             ...
                             "roles/aiplatform.user"]
            dataset_roles = {
                "s03e05" = ["roles/bigquery.dataEditor"]
            }
            cr_roles = {
                "cr-mcp-workspace"   = ["roles/run.invoker"]
                "cr-mcp-web-gateway" = ["roles/run.invoker"]
        ...
        "cr-s04e01-okoeditor" = {
            source_dir    = "../lessons/s04e01-wdrozenia-rozwiazan-ai/task/cr-s04e01-okoeditor"
            cpu           = "1"
            memory        = "1Gi"
            public        = false
            cpu_idle      = true
            ...
            env           = {
                ...
                BQ_DATASET          = "s04e01"
                BQ_TABLE            = "audit"
                BQ_AUDIT_TABLE      = "af-aidevs.s04e01.audit"
                GEMINI_MODEL        = "gemini-3.8-flash"
                THINKING_LEVEL      = "low"
                LANGSMITH_TRACING   = "true"
                LANGSMITH_ENDPOINT  = "https://eu.api.smith.langchain.com"
        ...
        "cr-s04e03-domatowo" = {
            source_dir    = "../lessons/s04e03-kontekstowa-wspolpraca-z-ai/task/cr-s04e03-domatowo"
            cpu           = "1"
            memory        = "1Gi"
            public        = false
            cpu_idle      = true
            ...
            env           = {
                ...
                BQ_DATASET          = "s04e03"
                BQ_TABLE            = "audit"
                BQ_AUDIT_TABLE      = "af-aidevs.s04e03.audit"
                GEMINI_MODEL        = "gemini-3.8-flash"
                THINKING_LEVEL      = "low"
                LANGSMITH_TRACING   = "true"
                LANGSMITH_ENDPOINT  = "https://eu.api.smith.langchain.com"

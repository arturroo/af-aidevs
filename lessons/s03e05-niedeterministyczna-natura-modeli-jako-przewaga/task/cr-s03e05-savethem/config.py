...
# Toolsearch endpoint resolution with fallbacks
AIDEVS_TOOLSEARCH_URL = (
    os.getenv("AIDEVS_TOOLSEARCH")
    or os.getenv("AIDEVS_TOOLSEARCH_URL")
    or os.getenv("AIDEVS_API_TOOLSEARCH")
    or f"{AIDEVS_BASE_URL}/api/toolsearch"
).strip()

# Preview simulator URL
AIDEVS_SAVETHEM_PREVIEW_URL = (
    os.getenv("AIDEVS_SAVETHEM_PREVIEW_URL")
    or f"{AIDEVS_BASE_URL}/savethem_preview.html"
).strip()
...
# BigQuery Auditing
BQ_DATASET = os.getenv("BQ_DATASET") or "s03e05"

...
| :--- | :--- | :--- |
| **Main Goal** | Precise execution of instructions | Autonomous goal achievement within set boundaries (Goal-oriented) |
...
> "If you can draw the task's algorithm on a piece of paper — use code. Introduce AI only where flexibility and understanding of the context are necessary."

...
# OKO Panel URL (resolved strictly from environment variables)
AIDEVS_OKO_PANEL_URL = (os.getenv("AIDEVS_OKO_PANEL_URL") or "").strip()
...
# BigQuery Auditing
BQ_DATASET = os.getenv("BQ_DATASET") or "s04e01"

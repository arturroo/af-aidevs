...
AIDEVS_NOTES_URL = (
    os.getenv("AIDEVS_S04E04_NOTES_URL")
    or os.getenv("AIDEVS_NOTES_URL")
    or f"{AIDEVS_BASE_URL}/dane/natan_notes.zip"
).strip()

AIDEVS_FILESYSTEM_PREVIEW_URL = (
    os.getenv("AIDEVS_S04E04_FILESYSTEM_PREVIEW_URL")
    or f"{AIDEVS_BASE_URL}/filesystem_preview.html"
).strip()
...
# BigQuery Auditing
BQ_DATASET = os.getenv("BQ_DATASET") or "s04e04"
...
GEMINI_FLASH_LITE_MODEL = (
    os.getenv("GEMINI_FLASH_LITE_MODEL") or "gemini-2.5-flash-lite"
)

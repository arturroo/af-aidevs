...
AIDEVS_BASE_URL = (os.getenv("AIDEVS_API_BASE_URL") or os.getenv("AIDEVS_BASE_URL") or "https://hub.ag3nts.org").rstrip("/")

# Shell API endpoint resolution with fallbacks
raw_shell = (
    os.getenv("AIDEVS_API_SHELL")
    or os.getenv("AIDEVS_SHELL")
    or os.getenv("AIDEVS_SHELL_URL")
    or f"{AIDEVS_BASE_URL}/api/shell"
).strip()
AIDEVS_SHELL_URL = raw_shell
...
# BigQuery Auditing
BQ_DATASET = os.getenv("BQ_DATASET") or "s03e02"
